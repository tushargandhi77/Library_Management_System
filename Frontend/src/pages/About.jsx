...
const About = () => {
  return ( 
    <div>
      ...
      <p>Welcome to our Library Management System. Our system is designed to efficiently manage the resources of a library, making it easier for librarians to organize, track, and lend books to patrons.</p>
      <h2>Our Mission</h2>
      ...
      <ul>
        <li>Email: info@librarymanagementsystem.com</li>
